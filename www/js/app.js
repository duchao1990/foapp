...
.run(['$ionicPlatform','$rootScope','$location','ConfigSer', '$ionicHistory','$cordovaToast','$cordovaAppVersion',function ($ionicPlatform, $rootScope, $location, ConfigSer, $ionicHistory,$cordovaToast,$cordovaAppVersion) {
...
.config(function($stateProvider, $urlRouterProvider,$ionicConfigProvider) {
  ...
  .state('myfo', {
    url: '/myfo',
    cache:false,
    templateUrl: 'html/act/myfo.html',
    controller: 'MyfoCtrl'
  })
  .state('mybmlist', {
    url: '/mybmlist/:bmid',
    templateUrl: 'html/act/mybmlist.html',
    controller: 'MybmlistCtrl'
  })
  .state('mybminfo', {
    url: '/mybminfo/:bmid',
    templateUrl: 'html/act/mybminfo.html',
    controller: 'MybminfoCtrl'
  })

  .state('fomuyu', {
      url: '/fomuyu',
          templateUrl: 'html/act/fomuyu.html',
          controller: 'MuyuCtrl'
    })
  .state('fochanxiu', {
      url: '/fochanxiu',
          templateUrl: 'html/act/fochanxiu.html',
    ...
    .state('tab.newslist', {
      ...
      views: {
        'tab-base': {
          templateUrl: 'html/news/list.html',
    ...
    .state('tab.ri', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/pra/ri.html',
        }
      }
    })
    .state('gongde', {
      url: '/gongde',
      templateUrl: 'html/pra/gongde.html',
      controller: 'GongdeCtrl'
    })
    ...
    .state('tab.muyu', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/pra/muyu.html',
          controller: 'MuyuCtrl'
        }
      }
    })
    .state('tab.chanxiu', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/pra/chanxiu.html',
          controller: 'ChanxiuCtrl'
        }
      }
    })
    .state('tab.paihang', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/pra/paihang.html',
        }
      }
    ...
    .state('tab.practice', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/tab-practice.html',
    ...
    .state('tab.pralog', {
      ...
      views: {
        'tab-practice': {
          templateUrl: 'html/pra/pralog.html',
        }
      }
    })
    .state('tab.integral', {
      ...
      views: {
        'tab-user': {
          templateUrl: 'html/user/integral.html',
    ...
    .state('allyuan', {
      url: '/allyuan/:qid',
      cache:false,
      templateUrl: 'html/act/allyuan.html',
      controller:'AllyuanCtrl'
    })
    .state('setyuan', {
      url: '/setyuan/:qid',
      cache:false,
      templateUrl: 'html/act/qiyuan.html',
  ...
  .state('tab.say',{
    ...
    .state('tab.issuelist',{
      ...
      views:{
        'tab-say':{
          templateUrl:'html/say/issuelist.html',
    ...
    .state('tab.musiclist',{
      ...
      views:{
        'tab-say':{
          templateUrl:'html/say/musiclist.html',
    ...
    .state('tab.playing',{
      ...
      views:{
        'tab-say':{
          templateUrl:'html/say/playing.html',
          controller:'PlayCtrl'
        }
      }
    })
